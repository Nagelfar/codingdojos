...
namespace DojoOLGTests
{
    ...
    public class PositionTests
    {
        ...
        [TestMethod]
        public void WhenAPositionWouldBeOutsideTheBoardBecauseOfAddition_ThenItIsWrapped()
        {
            var boardSize = new BoardSize(2, 2);
            var position = new Position(boardSize, 1, 1);

            var newPosition = position.Add(1, 1);
            Assert.AreEqual(new Position(boardSize, 0, 0), newPosition);
        }
